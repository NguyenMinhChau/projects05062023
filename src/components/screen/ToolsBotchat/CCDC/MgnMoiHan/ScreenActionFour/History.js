...
export default function HistoryActionFourScreen({navigation, route}) {
  ...
  const {
    ...
    handleReset,
    dateFilterConfirm,
  } = useMgnMoiHanActionFour(data, data?._id);
    ...
    <>
      ...
      <SafeAreaWrap
        ...
        <BannerNestedScreen
          ...
          title={`Danh sách báo cáo lịch sử hàn nối cho triển khai/nâng cấp ${nameDevice}`}
        ...
        <View style={{flex: 1, backgroundColor: colors.WHITE_COLOR}}>
          <View style={tw.style('gap-1 flex-row p-2')}>
            ...
            <ButtonCP
              ...
              onPress={() => {
                navigation.navigate({
                  name: SCREEN_NAVIGATE.Mgn_Moi_Han_Action_Four_Screen,
                  params: {
                    data: data,
                  },
                });
