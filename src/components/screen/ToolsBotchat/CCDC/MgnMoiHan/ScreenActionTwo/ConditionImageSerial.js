...
export default function ConditionImageSerial() {
    ...
    <>
      ...
      <View style={tw.style('flex-row flex-wrap gap-3 my-3')}>
        ...
        <RenderItemImageTemplate
          topic="Serial thân máy"
          type="68S+"
          uri={require('../../../../../../assets/CCDC/serial_than_may/68S_plus.jpg')}
          setDataImage={setDataImage}
        />
        <RenderItemImageTemplate
          topic="Serial thân máy"
          type="Fitel"
          uri={require('../../../../../../assets/CCDC/serial_than_may/filtel.jpg')}
          setDataImage={setDataImage}
        />
        <RenderItemImageTemplate
          topic="Serial thân máy"
          type="Fujikura 70S / 70S+"
          uri={require('../../../../../../assets/CCDC/serial_than_may/70S_70S_plus.jpg')}
          setDataImage={setDataImage}
        />
      </View>
      {/* MODAL VIEW IMAGE */}
