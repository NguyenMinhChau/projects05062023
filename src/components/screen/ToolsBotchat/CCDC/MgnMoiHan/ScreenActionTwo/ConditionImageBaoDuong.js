...
export default function ConditionImageBaoDuong() {
    ...
    <>
      ...
      <View style={tw.style('flex-row flex-wrap gap-3 my-3')}>
        <RenderItemImageTemplate
          topic="Thông tin bảo dưỡng"
          type="Comway"
          uri={require('../../../../../../assets/CCDC/thong_tin_bao_duong/comway.jpg')}
          setDataImage={setDataImage}
        />
        <RenderItemImageTemplate
          topic="Thông tin bảo dưỡng"
          type="Fitel S178"
          uri={require('../../../../../../assets/CCDC/thong_tin_bao_duong/fitel_s178.jpg')}
          setDataImage={setDataImage}
        />
        <RenderItemImageTemplate
          topic="Thông tin bảo dưỡng"
          type="Fujikura 68S+"
          uri={require('../../../../../../assets/CCDC/thong_tin_bao_duong/Fujikura/68S_plus.jpg')}
          setDataImage={setDataImage}
        />
        <RenderItemImageTemplate
          topic="Thông tin bảo dưỡng"
          type="Fujikura 70S / 70S+"
          uri={require('../../../../../../assets/CCDC/thong_tin_bao_duong/Fujikura/70S_70S_plus.jpg')}
          setDataImage={setDataImage}
        />
      </View>
      {/* MODAL VIEW IMAGE */}
