...
import {
  CREATE_REPLACE_DEV_FACILITY,
  UPDATE_REPLACE_DEV_FACILITY,
} from '../../../services/tools';
...
export default function ReplaceDevFacility({
  dataPop = [],
  type_job_vi = '',
  handleTimePress,
  handleTimeConfirm,
  ...
  const handleFormSubmit = () => {
    ...
    CREATE_REPLACE_DEV_FACILITY({payload, dispatch, openNotificationToast});
  };
