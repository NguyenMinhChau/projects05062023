...
import {
  CREATE_RELOCATION_METRO_POP,
  UPDATE_RELOCATION_METRO_POP,
} from '../../../services/tools';
...
export default function RelocationMetroPop({
  dataPop = [],
  type_job_vi = '',
  handleTimePress,
  handleTimeConfirm,
  ...
  const handleFormSubmit = () => {
    ...
    CREATE_RELOCATION_METRO_POP({payload, dispatch, openNotificationToast});
  };
