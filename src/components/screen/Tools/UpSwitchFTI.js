...
import {
  CREATE_UP_SWITCH_FTI,
  UPDATE_UP_SWITCH_FTI,
} from '../../../services/tools';
...
export default function UpSwitchFTI({
  dataPop = [],
  type_job_vi = '',
  handleTimePress,
  handleTimeConfirm,
  ...
  const handleFormSubmit = () => {
    ...
    CREATE_UP_SWITCH_FTI({payload, dispatch, openNotificationToast});
  };
  ...
  const ButtonActions = () => {
    return (
      <View style={tw`w-full flex-row py-2 gap-2 items-center justify-between`}>
        <ButtonCP
