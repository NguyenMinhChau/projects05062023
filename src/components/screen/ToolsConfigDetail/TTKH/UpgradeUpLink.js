...
import {
  HANDLE_CONFIG_UPGRADE_LINK,
  HANDLE_TERMINATED_PLAN_UPGRADE_LINK,
} from '../../../../services/tools';
...
export default function TTKHUpgradeUplink({idTask, dataByObjId}) {
  ...
  const handleConfig = type => {
    ...
    HANDLE_CONFIG_UPGRADE_LINK({
      ...
      step: type,
      _id: idTask,
      typeJop: TYPE_JOB.UPGRADE_UPLINK,
