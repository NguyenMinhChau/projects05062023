...
export const PLAN_WELD_IMAGE_SERVICE = async (props = {}) => {
  const {
    state,
    dispatch,
  ...
  try {
    ...
    openNotificationToast({
      title: 'Thông báo',
      message: 'Gửi lịch sử hàn nối cho triển khai/nâng cấp thành công!',
...
export const PLAN_WELD_IMAGE_SERVICE_UPDATE = async (props = {}) => {
  const {
    state,
    dispatch,
    openNotificationToast,
  ...
  try {
    ...
    openNotificationToast({
      title: 'Thông báo',
      message: 'Cập nhật lịch sử hàn nối cho triển khai/nâng cấp thành công!',
      type: TYPE_NOTIFICATION.SUCCESS,
    });
  } catch (error) {
    const msg = error?.response?.status
...
export const GET_LIST_MACHINE_DEFECT_BY_ID_FOUR = async (props = {}) => {
...
export const GET_LIST_IMAGE_MACHINE_DEFECT_BY_ID_FOUR = async (props = {}) => {
...
export const CONFIRM_UPLOAD_IMAGE_SERVICE_FOUR = async (props = {}) => {
  const {state, dispatch, openNotificationToast, payload} = {...props};
  startFunc(dispatch);
  try {
